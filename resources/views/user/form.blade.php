 ...
 <div class="form-group row">
     ...
     <div class="col-md-9">
         <input type="text" name="direccion" id="direccion" class="form-control" placeholder="Ingrese la direccion" pattern="^[a-zA-Z_áéíóúñ\s]{0,200}$">
     </div>
 </div>

 <div class="form-group row">
     <label for="documento" class="col-md-3 form-control-label">Documento</label>
     <div class="col-md-9">
 ...
 <div class="from-group row">
     <label for="rol" class="col-md-3 form-control-label">Rol</label>
     <div class="col-md-9">
...
<br>
 <div class="form-group row">
     <label for="usuario" class="col-md-3 form-control-label">Usuario</label>
     <div class="col-md-9">
